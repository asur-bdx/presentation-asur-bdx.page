---
title: "Bienvenue aux Assises locales bordelaises pour l'Université et pour la Recherche"
---
...
Pleinement intégrées à ce processus, ces instances locales contribueront à la réflexion par la rédaction d’un document de synthèse. Celui-ci, qui a vocation à être publié en propre tout en nourrissant le Livre blanc, permettra d’aller plus loin que la première mouture issue du colloque de lancement des Assises. Il pourra ainsi apporter des analyses inédites, formuler des critiques ou approfondir et compléter certains chapitres du Livre blanc issu du colloque. Il pourra également inclure un état des lieux de la situation régionale, destiné à être annexé, ou proposer une relecture critique (commentaires, corrections, reformulations) de ce document initial. Afin de consolider ces remontées, chaque Assise locale mandatera deux personnes qui participeront à la rédaction finale du Livre blanc, en veillant à respecter la parité et à la diversité des statuts.
